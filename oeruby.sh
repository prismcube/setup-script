...
BASE_VERSION=9
OE_ENV_FILE=${PWD}/environment-angstromv2012.12
...
echo "       $0 clean"
echo "       $0 build <make image name>"
echo ""
echo "       Not recommended, but also possible:"
echo "       $0 bitbake <bitbake target>"
echo "       It is recommended to do '. ${OE_ENV_FILE}' and run 'bitbake something' inside ${BUILDDIR} without using oeruby.sh as wrapper"
echo ""
